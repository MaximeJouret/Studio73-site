        ...
        <AnimatedSection>
          <div className="mt-8 max-w-4xl">
            <h2 className="text-2xl md:text-4xl font-bold leading-tight mb-8">
              ...
              <span className="text-accent">fondée à Bruxelles.</span>
            </h2>
          ...
          <div className="space-y-6">
            {steps.map((step, i) => (
              <AnimatedSection key={step.num} delay={i * 0.08}>
                <div className="group flex flex-col md:flex-row gap-6 md:gap-12 p-8 rounded-2xl border border-border bg-muted hover:border-accent/50 transition-all duration-300">
