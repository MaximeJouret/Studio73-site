...
export default function RBFAProjectPage() {
  const project = getProjectBySlug("rbfa");
  if (!project) return null;

  const accent = project.color;
  const accentSecondary = project.colorSecondary ?? "#FFCD00";

  return (
    <div
      className="min-h-screen"
      style={{ backgroundColor: project.background ?? "#000000" }}
    >
      {/* Hero */}
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl lg:text-9xl font-bold tracking-tight leading-[0.95] text-white">
              <span className="block">RBFA</span>
              <span
